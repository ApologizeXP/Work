...
$sql = "SELECT * FROM request ORDER BY time DESC   ";
        ...
        <table>
            ...
            while ($row = $result->fetch_object()) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_request_admin.php?id=<?php echo $row->requestid; ?>"><button>แก้ไข</button></a>
                        <a href="delete_request_admin.php?id=<?php echo $row->requestid; ?>"><button>ลบ</button></a>
                    </td>
                    <td>
                        <?php
