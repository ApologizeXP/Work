...
<body>
    ...
    <a href="show_request_admin.php"><button>แสดงใบเสนอลูกค้า</button></a>
    <br>
    <br>
    <div>
        <form action="edit_request_admin_db.php" method="POST">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="amount1" id="amount1" value="<?php echo $row['amount1']; ?>"><br><br>
                        <input type="number" name="amount2" id="amount2" value="<?php echo $row['amount2']; ?>"><br><br>
                        <input type="number" name="amount3" id="amount3" value="<?php echo $row['amount3']; ?>"><br><br>
                        <input type="number" name="amount4" id="amount4" value="<?php echo $row['amount4']; ?>"><br><br>
                        <input type="number" name="amount5" id="amount5" value="<?php echo $row['amount5']; ?>">
